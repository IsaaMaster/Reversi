...
socket.on('game_over', (payload) => { 
    ...
    let nodeC = $("<h2 style='color:black'>" + payload.who_won + "</h2>");
    ...
    $('#gameOverMessage').html(nodeC); 
    $('#returnToHome').attr('href', 'lobby.html?username=' + username);
    let gameOverModal = $('#gameOver');
